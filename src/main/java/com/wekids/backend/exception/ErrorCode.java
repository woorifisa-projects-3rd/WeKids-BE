...
public enum ErrorCode {
    ...
    NOT_FIND_COOKIE(INTERNAL_SERVER_ERROR, "쿠키를 찾을 수 없습니다."),
    EXPIRE_TOKEN(INTERNAL_SERVER_ERROR, "만료된 토큰입니다."),
    INVALID_TOKEN_CATEGORY(INTERNAL_SERVER_ERROR, "유효하지 않은 종류의 토큰입니다."),
    NOT_FIND_TOKEN(INTERNAL_SERVER_ERROR, "토큰을 찾을 수 없습니다.");
